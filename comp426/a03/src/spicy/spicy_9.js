...
export const repeatDemo = () => {
    repeat(function(s){console.log(s)}, 10, "Hello, world!")
};
// repeatDemo()
...
export const allEvensAreOdd = (arr) => {
    return everyEven(arr, function(a){return a/2 != Math.floor(a/2)})
};
// console.log(allEvensAreOdd([1, 1, 3, 1, 3, 3]))
...
export const anEvenIsOdd = (arr) => {
    return someEven(arr, function(a){return a/2 != Math.floor(a/2)})
};
