...
public class MinBinHeap_Playground {
	...
	public static void TestBuild(){ 
		...
		EntryPair[] collection= new EntryPair[12];
		...
		collection[8]=new EntryPair("t",7);
		collection[9]=new EntryPair("j",29);
		collection[10]=new EntryPair("o",10);
		collection[11]=new EntryPair("p",13);
